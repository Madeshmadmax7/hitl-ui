    ...
    return (
        <div className="bg-black text-white font-outfit">
            ...
            <section className="px-6 max-w-7xl mx-auto grid md:grid-cols-12 gap-12">
                ...
                <div className="md:col-span-6 flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-4 mt-10">
                        <button className="h-12 w-12 flex items-center justify-center rounded-full border border-white/40 hover:border-white transition">
                            <Play size={18} />
                        </button>
            ...
            <section className="px-6 py-20 max-w-7xl mx-auto">
                <h2 className="text-[38px] font-semibold mb-10">We Are Certified</h2>
